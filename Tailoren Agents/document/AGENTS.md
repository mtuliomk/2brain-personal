...
Considere exclusivamente as skills instaladas e disponibilizadas pelo ambiente, incluindo as fornecidas por plugins instalados.
...
A ausência de uma skill adequada não bloqueia a entrega: registre o erro ou a ausência real e siga com evidências verificáveis. Somente após essa análise o agente principal pode montar as mensagens de delegação. Para cada subagente, indique explicitamente as skills aplicáveis que ele deve priorizar e o motivo da priorização. O subagente deve reler integralmente os respectivos `SKILL.md` antes de iniciar a própria investigação e pode usar outras skills disponibilizadas pelo ambiente apenas quando forem claramente pertinentes à sua responsabilidade.
...
Na mensagem de criação de cada subagente, o agente principal deve indicar explicitamente as skills prioritárias que selecionou, com seus caminhos completos informados pelo ambiente e a justificativa de cada prioridade. O subagente deve ler integralmente cada `SKILL.md` prioritário **antes** de iniciar a investigação e seguir suas orientações na redação. Pode usar outra skill disponibilizada pelo ambiente somente quando sua pertinência para a responsabilidade exclusiva for clara; nesse caso, deve registrá-la na entrega. Não basta citar uma skill na mensagem ou no relatório final.

| Subagente             | Instrução obrigatória a enviar                                                                                                                                                                                                                                                                                                                                                 |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `architecture`        | `Antes de investigar ou redigir, leia integralmente e aplique as skills prioritárias aplicáveis à arquitetura indicadas abaixo: <lista de skills prioritárias, com caminhos completos e justificativa>. Sua responsabilidade exclusiva é investigar a arquitetura atual e devolver um rascunho completo de ARCHITECTURE.md, com evidências e limitações.`                      |
| `product`             | `Antes de investigar ou redigir, leia integralmente e aplique as skills prioritárias aplicáveis a produto indicadas abaixo: <lista de skills prioritárias, com caminhos completos e justificativa>. Sua responsabilidade exclusiva é investigar os produtos existentes e devolver um rascunho completo de PRODUCT.md, com evidências e limitações.`                            |
| `security_compliance` | `Antes de investigar ou redigir, leia integralmente e aplique as skills prioritárias aplicáveis a segurança e compliance indicadas abaixo: <lista de skills prioritárias, com caminhos completos e justificativa>. Sua responsabilidade exclusiva é investigar segurança e compliance e devolver um rascunho completo de SECURITY-COMPLIANCE.md, com evidências e limitações.` |
